...
public class Game extends PApplet {
	...
	private String[] models = {"City","Farm","Fishing Boats","Forest1","Forest2","Forest3","Forest4","Galley","Lumbermill","Mine","Rock","Ruins","Settler","Transport","Warrior","Windmill","Work Boat","Worker"};
