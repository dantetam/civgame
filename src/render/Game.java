...
public class Game extends PApplet {
	...
	private String[] models = {"City","Farm","Fishing Boats","Galley","Lumbermill","Mine","Ruins","Settler","Transport","Warrior","Windmill","Work Boat","Worker",
			"Forest1","Forest2","Forest3","Forest4","Rock1","Rock2","Rock3"};
